...
sudo cp /vagrant/temp/data/run_experiments_ND_performance_regulatory.sh /home/sbl/run_experiments_ND_performance_regulatory.sh
sudo cp /vagrant/temp/data/run_experiments_ND_performance_regulatory.sh /home/sbl/run_experiments_ND_performance_protein.sh
sudo cp /vagrant/temp/data/run_experiments_ND_performance_regulatory.sh /home/sbl/run_experiments_ND_performance_coauthorship.sh

sudo chmod 777 /home/sbl/run_experiments_ND_performance_regulatory.sh
sudo chmod 777 /home/sbl/run_experiments_ND_performance_protein.sh
sudo chmod 777 /home/sbl/run_experiments_ND_performance_coauthorship.sh

echo Linking the shell script into the root folder | tee -a $log
sudo ln -sv /home/sbl/run_experiments_ND_performance_regulatory.sh /run_experiments_ND_performance_regulatory.sh 
sudo ln -sv /home/sbl/run_experiments_ND_performance_regulatory.sh /run_experiments_ND_performance_protein.sh 
sudo ln -sv /home/sbl/run_experiments_ND_performance_regulatory.sh /run_experiments_ND_performance_coauthorship.sh 
